...
namespace AssemblyDefender.Net.SymbolStore.UnmanagedApi
{
	...
	[ComVisible(true)]
	public interface ISymUnmanagedWriter3 : ISymUnmanagedWriter, ISymUnmanagedWriter2
	{
		...
		/// </summary>
		/// <param name="method">The metadata token for the method to be opened.</param>
		/// <param name="isect">The section offset in the image.</param>
		/// <param name="offset">The offset in the image.</param>
		/// <returns>HRESULT</returns>
		[PreserveSig]
		int OpenMethod2(
			[In] int method,
